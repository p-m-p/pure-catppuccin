...
function createSvg(flavorName, colors) {
  ...
  <text y="${line1Y}" font-family="Hack Nerd Font Mono, monospace" font-size="${fontSize}">
    <tspan x="${paddingX}" fill="${colors.blue.hex}">~/dev/pure-catppuccin</tspan><tspan fill="${colors.mauve.hex}"> main</tspan><tspan fill="${colors.rosewater.hex}"> rebase</tspan><tspan fill="${colors.sapphire.hex}"> ⇡</tspan><tspan fill="${colors.yellow.hex}"> *</tspan><tspan fill="${colors.overlay1.hex}"> ≡</tspan>
  </text>
